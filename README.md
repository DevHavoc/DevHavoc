...
I build **scalable REST APIs**, **reliable backend systems**, and **data/AI-driven applications**.  
I’m deeply focused on **Clean Architecture, the C#/.NET ecosystem, Cloud/Azure, and engineering problem-solving**.
...
- 🏗️ RESTful APIs & Clean Architecture (Domain, Application, Infrastructure, Presentation)
- ⚡ C#, .NET Core & Entity Framework Core (CRUDs, Repository Pattern, Migrations)
- 🧩 DTOs, Dependency Injection, Versioning & Best Practices
- 🗄️ Relational Database Management (PostgreSQL, MySQL, SQL Server)
- ☁️ Azure Cloud Services & Microsoft Ecosystem Solutions
- 🤖 AI-assisted workflows & Data Engineering (PySpark, PyTorch, LLM Tools)
- 🔍 End-to-end System Debugging & Root Cause Analysis
- 🎓 Software Engineering Student @ UniALFA | C2 English Proficient (EF SET)
...
🤝 Open to technical discussions, collaborations, and backend development opportunities!